...
const features = [
  {
    ...
    cta: 'LEARN MORE',
    isSponsorship: true,
    // className: 'col-span-1 sm:col-span-1 lg:col-start-1 lg:col-end-2 lg:row-start-1 lg:row-end-2 min-h-full',
  },
  {
    Icon: () => null,
    name: ' ',
    description: ' ',
    // className: 'col-span-1 sm:col-span-1 lg:col-start-1 lg:col-end-2 lg:row-start-2 lg:row-end-3 min-h-full',
    background: (
      <div className="absolute inset-0 flex items-center justify-center p-6">
        <div className="grid grid-cols-4 gap-4 w-full">
          {socials.map(social => (
            ...
            >
              <img src={social.media.src} alt={social.media.alt} className="w-8 h-8" />
            </a>
          ))}
        </div>
      </div>
  ...
  },
  {
    ...
    href: '#',
    cta: 'View Details',
    // className: 'col-span-1 sm:col-span-2 lg:col-start-2 lg:col-end-3 lg:row-start-1 lg:row-end-3 min-h-full',
    background: (
  ...
  },
  {
    ...
    href: '#',
    cta: 'Learn More',
    // className: 'col-span-1 sm:col-span-1 lg:col-start-3 lg:col-end-4 lg:row-start-1 lg:row-end-2 min-h-full',

    background: (
      <div className="flex items-center justify-center w-full h-full">
        <div className="text-4xl font-bold absolute mt-6 p-4 right-10 top-10 origin-top scale-95 rounded-md border transition-all duration-300 ease-out group-hover:scale-90">
  ...
  {
    Icon: () => <img src={user} alt="Users" className="w-10 h-10" />,
    name: 'Users',
    description: 'Total number of registered users',
    href: '#',
    // className: 'col-span-1 sm:col-span-1 lg:col-start-3 lg:col-end-4 lg:row-start-2 lg:row-end-3 min-h-full',
    background: (
      <div className="flex items-center justify-center w-full h-full">
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen">
      ...
      <div className="flex-1 w-full p-4">
        ...
        <BentoGrid className="mt-6 h-[calc(100vh-8rem)] lg:grid-rows-3 gap-4">
