...
```
  ...
  <div className="step">
  ## Run projects
<Tabs groupId="projects" items={['Devtools', 'Documentation', 'Back-End', 'Portal', 'Website', 'Slides']} persist>
...
<Tabs groupId="devtools-nx-commands" items={['Docs', 'Architecture', 'Storybook']} persist>
  <Tab value="Docs">
