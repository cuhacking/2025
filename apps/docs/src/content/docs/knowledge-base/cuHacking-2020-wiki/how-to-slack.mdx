...
![slack-preview](/cuhacking-2020-images/slack-preview.png)
...
![slack-channel-mention](/cuhacking-2020-images/slack-channel-mention.png)

### @here

Notify everyone who is currently online in this channel.

![slack-here](/cuhacking-2020-images/slack-here.png)

### @everyone

Use in the #general channel to notify everyone in the workspace.

![slack-everyone](/cuhacking-2020-images/slack-everyone.png)

### @\<name\>

Type a person’s name after the @ symbol to notify them.

![slack-name](/cuhacking-2020-images/slack-name.png)

### #\<channel\>

You can link a channel in a message using the # symbol; useful if you want to point people to a specific channel.

![slack-channel-link](/cuhacking-2020-images/slack-channel-link.png)
...
![slack-context-menu](/cuhacking-2020-images/slack-context-menu.png)
...
![slack-call-button](/cuhacking-2020-images/slack-call-button.png)
...
![slack-search](/cuhacking-2020-images/slack-search.png)
...
1. Press the workspace button in the top left corner and go to `Preferences` (or Press `Cmd + ,`/`Ctrl + ,`)
   ...
   ![slack-workspace-button](/cuhacking-2020-images/slack-workspace-button.png)
   ![slack-preferences-button](/cuhacking-2020-images/slack-preferences-button.png)

2. Press `Sidebar`

   ![slack-sidebar-button](/cuhacking-2020-images/slack-sidebar-button.png)

3. Scroll down to `Custom Theme`

   ![slack-custom-theme](/cuhacking-2020-images/slack-custom-theme.png)
