---
title: Roadmap
description: Where to Start with Extreme Programming (XP)
---

## Map


TODO: Fit with color schema and make it fit ino the page better (perhaps splitting into 2...)

Here's a diagrammed roadmap to exploring and adopting XP:
...
- **XP Communities and Meetups**: Join Agile and XP-focused meetups or conferences to learn from others who have successfully implemented XP.
- **Online Courses**: Platforms like [Coursera](https://www.coursera.org/) and [Udemy](https://www.udemy.com/) often offer courses on XP, Agile, and TDD.
- **Tools**:
   - **CI Tools**: [Jenkins](https://www.jenkins.io/), [Travis CI](https://www.travis-ci.com/), [CircleCI](https://circleci.com/)
   - **UI Tools**: [Farabi's Gist](https://gist.github.com/er-ant/e8c2f8c47ad871a4685c2a17800c86ae)