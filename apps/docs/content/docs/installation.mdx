...
[Learn more](https://en.wikipedia.org/wiki/Windows_Subsystem_for_Linux).
  ...
  <Accordion title="Do I need to switch to the dark side and code in shell?">
    ...
    directories with the Windows file explorer graphically.
      ...
      <div className="steps">
        <div className="step">
          <kbd> Win+X, A</kbd> to open PowerShell as Administrator

          ```sh title="Powershell"
          wsl --status
          ```

If you see this, you already have both WSL and Ubuntu installed.
```
...
If you'd like to do a fresh install, delete the distribution first.
```sh
wsl --unregister ubuntu
```

If you see this, you have both WSL installed, but without a distribution.
```
...
If there's no output, install a WSL distribution.

          ```sh title="Powershell"
          wsl --install -d ubuntu # Will install WSL2 by default
          ```
          You should see:
          ...
          Restart your machine once you see:
          ```
          ...
          Restart-Computer
          ```
          Open PowerShell as Administrator again with
          <kbd> Win+X, A</kbd>

You should immediately see WSL begin installing. Else if you're in a regular powershell session instead, do:
...
![Image](https://github.com/user-attachments/assets/888a1253-da04-479f-b56a-0433f6ecea19)

Close the terminal and re-open it with:
          <kbd> Win+I</kbd>

You should see:
![Image](https://github.com/user-attachments/assets/87e93aa1-0769-4dcf-a027-9cd85c5b5821)
...
![Image](https://github.com/user-attachments/assets/4a4171c4-0a6c-4e1f-9da9-981e4c3493d2)
