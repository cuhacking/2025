...
<div className="steps">
  <div className="step">
    Read our [Tools Overview](/docs/tools-overview) to get an understanding of
    the technologies we use and why.
  </div>
  <div className="step">Follow along with the rest of this page.</div>
</div>
