...
# Postman
*If you're just interested in learning how to run Postman tests, skip down to the **<Link href={'#running-postman-tests'}>Running Postman Tests</Link>** section below.*

[Postman](https://www.getpostman.com/) is an application made to help build and test APIs. While Postman offers some tools for designing APIs, we're mostly interested in Postman's ability to test APIs. 
