import { UserHackathonApplicationStatus, UserProfileStatus } from '@cuhacking/portal/types/user'
...
import { HackerDock } from '@cuhacking/portal/ui/hackerdock'
...
export function Home() {
  return (
    <>
      ...
      <HackerDock status={UserProfileStatus.complete} />
    </>
  )
}
